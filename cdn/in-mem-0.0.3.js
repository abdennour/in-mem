  ...
  _createClass(DBMS, [{
    ...
    value: function update(table, where, newRecord) {
      ...
      recordIndexes.forEach(function (index) {
        ...
        _this3[index] = (0, _helper.updateObject)(_extends({}, newRecord, (_extends2 = {}, _defineProperty(_extends2, config.idCol, _this3[index][config.idCol]), _defineProperty(_extends2, 'lastUpdated', new Date()), _extends2)), _this3[index], override);
      });
